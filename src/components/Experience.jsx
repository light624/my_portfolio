  ...
  return (
    <div className="relative py-20 px-96">
      ...
      <Image
        ...
        width={400}
        height={400}
        className=" w-[300px] lg:w-[200px] absolute -top-4 right-0 opacity-70"
      />
      <div className="w-full h-full flex flex-col font-extrabold items-center justify-center gap-y-10 lg:gap-y-20 py-10">
        {experienceData.map((data, i) => (
          <div
            key={`id-${i}`}
            className={`w-[600px] xl:w-[480px] sm:w-full px-12 sm:px-0 relative ${
              i % 2 === 0 ? '-left-[300px]' : 'left-[300px]'
            }`}
          >
            <motion.div
            ...
            >
              ...
              <div className="text-gray-800">
                ...
                <ul className="pl-2">
                  {data.experience.map((exp, j) => (
                    <li key={`exp-${j}`} className="my-1 font-extralight">
                      {exp}
                    </li>
                  ))}
                </ul>
             ...
             <span
                className={`absolute top-1/2 text-red-300 -translate-y-1/2 ${
            ...
            <div
              className={`w-14 absolute top-1/2 border border-gray-300 rounded-full aspect-square grid place-items-center text-red-400 font-light -translate-y-1/2 bg-white z-10  hover:bg-slate-600 ${
                i % 2 === 0 ? 'left-[calc(100%+2rem)]' : 'right-[calc(100%+2rem)]'
              }`}
            >
